        ...
        <div class="item active">
            ...
            <div class="container">
                <div class="carousel-caption">
                    <h1>Welcome to eMusic Store</h1>
                    <p>Here you can browse and instruments, records, and music related accessories. Order now
        ...
        <div class="item">
            ...
            <div class="container">
                <div class="carousel-caption">
                    ...
                    <p>Through ups and downs, somehow I manage to survice in life</p>
                </div>
            </div>
        </div>
    </div>
